...
- 2026-08: distilled/2026/distilled-gm-2026-8.md
- 2026-09: distilled/2026/distilled-gm-2026-9.md
...
### Macro / Regime
- 機械regime **Equities Down / Oil Surge**（equities=down / oil=surge / **gold=off** / **crypto=range** / yields=rising）← wk04からラベル継続も内部悪化。**VIX 15.99で18割れ＝Add risk gate 再開**（2週閉鎖から転換）。
- ★**15年ぶりの日米協調介入**（7/30 NY時間に USD/JPY 163→158、円は最大3.3%急騰、**ドルは2023年1月以来最大の日次下落**／7/31に米財務省が複数行へ「待機」通告）。**--news #5（読売・8/2）が確定報道**。**coord_stage: meeting_held→executed／imf_ammo: 1→0**。**8/3(月)まで同一エピソード窓、8/4以降は4回目で分類逸脱**。
- **FOMC 5会合連続据え置き・9対3**（2016年9月以来の反対票数）、**9月利上げ確率64%**、Q2 GDP +1.5%の未達。日銀は**タカ派ホールド**だが会見のガイダンスは不足。
- **AI capex懸念は「選別」へ決着**（AWS+37%/Azure+43%/Alphabet+82%、Metaのみ-8.8%）。SOX+8%、KOSPI+17.91%、キオクシア歴史的出来高。
- 債券は**ツイスト・スティープナー**（US2Y週足-1.73% vs US10Y+0.79%、真の2s10s **+34.8→+45.6bp**）。★**機械5s10sは「stable」で取り逃がし、3m10s（+87.4→+106.3bp）が捉えた**。

### Position / Orders
- Core: **株数変更なし**。総資産 **4,833,577円 / +5.60%**（週間-41,369円だが**前日比+150,811円/+3.22%**）。★米国株は**外貨建+35.57USD改善も円換算-2,773円悪化＝協調介入の円高影響**。
- CFD: **確定1件・+1.45%・1勝0敗**。**7/31 21:31に0.5Lotを$4,048で利確**（トリガー＝**週足Fibo38.2の$4,062割れ**）、**残1Lot持越し**（$3,950ネック未割れ・日足実体上抜け・4H Wボトム）。
- Mode: **8/10までは上値トライ、以降一段の下落を警戒**。ドル円は月曜まで戻り売り・火曜以降ドル買い復帰だが**日付でなく価格の証明を待つ**。

### Key Levels (snapshot-based / 2026-08-02 ＋ Boss 1次)
- USDJPY: 157.400（Boss週足157.469/-3.88%）/ **161=0.5戻し売りゾーン**・戻り限界160.2-161.0 / 157.15割れ→**153.9**
- US100: 28,274（生死ライン28,173を回復）/ **28,500-28,800売り・28,000-27,700拾い** ／ SP500: **7,480.59（+0.89%）**
- JP225: **64,362.02**（★Boss §5の欠落を機械が補完）/ 押し目64,500・利確65,500
- XAUUSD: 4,049.1（Boss 4,046.34・gold=off）/ **4,062割れ済＝リスク下寄り** / 4,120-4,166戻り売り / **3,950最終防衛**
- WTI: 機械84.670 / Boss 86.80（既知フィード差）/ **88.53が switch**
- 金利: US10Y **4.745**（Boss週足4.718・金曜4.747＝**52週高値4.714を上抜け**）/ US2Y **4.262（-1.73%）** / 5s10s +28.5bp stable / **3m10s +106.3bp bull_steepening** / belly +26.0bp / **真の2s10s +45.6bp**
- **DXY: 99.802（-1.64%）＝100.257割れ** / 下は96.377まで空白 / ★**99.69が金の単独スイッチ**
- VIX: 15.990（gate再開）/ BTC: 62,814（Boss 62,882.70/-3.71%・wk04の分岐63,800.5を割り込み）

### Gates（最重要：終値で判定）
- Add risk: **再開**（VIX 15.99<18）。ただし**8/10までの期間限定**。再閉鎖＝VIX18回帰／NFP上振れ／US10Y 4.75%超え定着／WTI 88.5上抜け
- Reduce / caution: US10Y 4.745-4.810上抜け ／ 強いNFPでUS2Y 4.34-4.42急騰→フラット化→株にダブルパンチ ／ NAS100 27,700割れ・日経64,500割れ ／ WTI 88.53上抜け ／ ドル円157.15割れ→153.9 ／ ★**DXY 99.69割れ（金の前提が反転）**
- Hedge gate: Gold **残1Lot**（最終防衛**$3,950**）。**4,166を終値で上抜けるまでは戻り売り優位**、**方向感なし＝サイズを落とす**。上抜けの唯一の経路は**DXY 99.69割れ**

### This Week Focus & Catalysts（行動: 8/3-）
- **8/7(金) NFP**（予想+8.3万人／失業率4.3%）— ★**IMF窓（〜8/3）の外側**に落ちる非対称。日付でなく**「当局が撃たないことを価格が証明した後」**を待つ
- **8/3(月)までがIMF同一エピソード窓** — 「金曜と月曜は上がっても売り」
- **DXY 99.69** — ゴールドの前提を反転させる単独スイッチ（現値99.802＝わずか0.11）
- **US10Y 4.745-4.810 / US2Y 4.34-4.42** — 雇用統計当日は**2年債の反応を最初に確認**
- **WTI 88.53上抜け** — 株安・**金だけ反転**。--news #2（米国とイスラエルがイランのエネルギー施設に過去最大級の爆撃を計画）が燃料

---

## Weekly Brief | 2026-8-7_wk01（2026-08-03 → 2026-08-07）
created: 2026-08-08 JST / snapshot end=2026-08-08 / regime: **Gold Bid**（equities=**flat** / vol=normal / oil=**range** / **gold=bid** / crypto=range / yields=rising）
sources: Boss市況 wr-2026-8-7.md ＋ **専用トレードレポート Gold-2026-06-12_to_08-07 .md（6/12→8/7 全期間reconciled）** ＋ **週末終値チャート10枚**（US100/JP225/USDJPY/EURUSD/DXY/XAUUSD/WTI/**US30Y**/US10Y/US2Y）＋ 口座3枚 ＋ main.py --trade --news ＋ X headlines（`-p grok`・**2週連続成功**）

### Macro / Regime
- wk05「Equities Down / Oil Surge」から **3項目が同時に転換** → **`Gold Bid`**（**gold は off→bid の2段階改善**・oil surge→range・equities down→flat）。VIX 15.99→**14.90** で **Add risk gate 開放継続**。
- ★**8/7 NFP -23,000人**（予想+83,000）＝**純減**。**5-6月合計 -103,000人の下方修正**、12ヶ月平均も月+34,000へ鈍化。**失業率4.2%→4.1%は労働参加率61.5%→61.4%（5年超ぶり低水準）による質の悪い改善**。一時解雇+153,000→**921,000人**、平均時給**前年比+3.2%** → **スタグフレーション型**でFRBは「**conundrum（板挟み）**」。
- ★**利上げは「否定」でなく「先送り」**: **9月42%**（50%割れ）だが **10月まで57%超**。**US2Yは日中安値4.154%→引けにかけ4.199%まで+4.5bp買い戻し**、US10Yも4.639→**4.649%** ＝ **市場は金利低下を最後まで追いかけなかった**。
- **金が週次+7.20%**（4,049→4,340.7）。Boss実測 現物 **4,342.41（+2.43%）**・高値 **4,370.49** で**7週間ぶり高値圏**、日足抵抗4,302.18も上抜け。理由3層＝**スタグフレーション懸念＋ドル安（DXY 99.604＝6週ぶり安値圏）＋ホルムズ再開による原油下落**＋中銀の継続買い。★**1/29の最高値5,585-5,589から依然20%以上下＝下降チャネル内の戻り**。
- **米国株は強気シナリオが的中**: NDX **29,722.30（+1.19%）**、**S&P500 7,757.64 は8/6に史上最高値**でその週は4月以来最強。**WTIだけ別ドライバーで週間-8.96%**（**イラン=オマンのホルムズ再開合意が近い**＝**TACOリスク顕在化**）。
- **ドル円はNFP後もほぼ無風の157.78** ＝ **介入効果の剥落**（7/31の協調介入で163→155だが**値幅の半分近くを既に戻した**）。ベッセント『**介入はシグナル、方向を変えるのは政策**』。

### Position / Orders
- Core: **株数変更なし**。総資産 **4,993,914円 / +417,056円 / +9.11%**（wk05 +5.60%）。★**米国株が -18.10%→-3.95% へ劇的改善**（**GDX +196.65 USD 黒字転換**＝金急騰の直撃、**IONQ +121.24 USD 黒字転換**、SPCXは**8/6ロックアップ解除を+1.5%で吸収**）。国内株は**GXゴールド特定も黒字転換**、一方**ファナックが-55,300で最大の重し**（wk05から牽引役が入れ替わり）。
- CFD: ★**8/7に全決済しフラット**。当週 **+224.25 pt·Lot（+10.94%）**＝X5（8/6 0.5Lot@4,300／**根拠が当事者に否定された**）＋X6（8/7 0.5Lot@4,350／高値4,370.51→**1分足DT切り下げ**）。**キャンペーン通算（6/12→8/7・57日）確定6件・6勝0敗・+505.75 pt·Lot（+21.06%）**、最大逆行-76.7 pt·Lot。玉割当は**FIFO**。
- Mode: **8/12 CPIまではポジション軽め・追いかけ買いをしない**。

### Key Levels (close-based)
- US100 29,722.30 ／ **29,560-29,600が上抜けたサポート** ／ 上 29,870→30,000→30,922 ／ **29,560割れで初めてダマシ**
- JP225 現物 65,606.71 ／ **CFD夜間66,248＝月曜600-650円上ギャップ想定** ／ 押し目 **66,340〜66,000** ／ 上 67,353→67,596 ／ 66,000割れでギャップ埋め65,606
- USDJPY 157.78 ／ **157.0〜158.5レンジ** ／ 上 158.50-158.56→159.20-159.50（戻り売り） ／ 下 157.086→**156.589**→155.7
- XAUUSD 4,342.41 ／ **4,302.18（旧抵抗→新サポート）が試金石** ／ 上 4,370.49→4,380.85→4,400 ／ 下 4,248.25→4,216.34 ／ **最終防衛 $3,940（8/8以降の新基準・実運用検証は未実施）**
- WTI 77.08 ／ **76.705が重要（割れると加速）**→74.899→70.00 ／ 上 78.77→79.762→82.749
- 金利 US2Y **4.199%**（★**4.154割れ or 4.256超えが起点**）／ US10Y 4.649% ／ **US30Y 5.202%**（上5.237→**5.28＝2007年来高値**）
...
- DXY **99.604**（★**99.527が全通貨ペア共通トリガー**）／ EURUSD 1.1558（**1.15741ブレイク待ち**）／ VIX 14.90 ／ BTC 64,975（**64,132割れは未発生**）
...
- **Hedge gate**: ★**CFDフラット＝ヘッジ枠ゼロ**。再構築は**4,302.18を上抜けサポートとして守れる確認後**。**上値追随の条件は DXY 99.527割れ かつ 10s30s拡大**（ドル安だけでは足りない）

### This Week Focus & Catalysts（行動: 8/10-）
- ★**8/12(水) 米7月CPI — 今週最大のイベント**。**強ければ**10月70-80%→**株安・ドル高・金は板挟み**／**弱ければ**利上げ観測ほぼ消滅→**株・金の同時上昇、EURUSD 1.16**。**どちらでもボラは金曜より確実に大きい**
- **8/11(火) 日本休場（山の日）** ／ **8/13(木) 米7月PPI** ／ **8/28(金) BLS年次ベンチマーク改定の速報値**（**過去1年の雇用者数が大幅下方修正されるリスク**）
- **ホルムズ交渉**（正式合意→70ドル方向／決裂→82.749）。X市況の懐疑「**紙の価格は織り込んだが、海（実物流）はまだ戻っていない**」
- ★**設計変更（トレードレポート§7-3の指摘を受けた是正）**: 「**wk05のシナリオツリーに反対方向の分岐がなく、US100レンジ想定が29,112まで破られた**」→ **本週から主要リスクごとに反対方向の分岐を明示**する構成へ

### Signals (weekly, fixed keys)
- us10y_accel: hike_postponed_curve_flattened（US2Y 4.199 / US10Y 4.649 / **US30Y 5.202**。9月42%・10月57%超＝**否定でなく先送り**。3m10s +106.3→**+95.0bp**、**belly_premium +26.0→+18.9bp**）
- hy_oas_widening: bad_news_is_good_news_two_layer（NFP純減→利上げ先送り→株ATH・金高。ただしX市況は**高バリュエーション・9月季節性の警戒も一定数＝乗りつつ天井感を意識する二層構造**）
- vix_spike: add_risk_gate_open_14_90（18割れ継続。金利低下＋S&P最高値更新でボラ一段低下）
- wti_shock: hormuz_reopening_taco_realized（77.08・**週間-8.96%**。動画の79.50上昇は不成立で逆方向。**76.705が方向を決める**）
- eps_revision_chain: gold_bid_and_toshiba_kioxia_gain（**gold off→bidの2段階**で金鉱株GDXが黒字転換。--newsは**東芝の4-6月期純利益が前年同期比約30倍の4兆4673億円**＝キオクシア株の評価益）

---

## Weekly Brief | 2026-8-21_wk03（2026-08-17 → 2026-08-21）
created: 2026-08-23 JST / snapshot end=2026-08-23 / regime: **Gold Bid**（equities=**up** / vol=normal / oil=range / **gold=bid** / crypto=**strong** / yields=rising）
sources: Boss市況 wr-2026-8-21.md（**本体 8/21 ＋ Rex追記§A-K 8/22**）＋ 口座3枚＋**リバランス明細**（2026-08-23 09:18）＋ **週末終値チャート10枚**（US100/JP225/USDJPY/EURUSD/DXY/XAUUSD/WTI/US30Y/US10Y/US2Y）＋ main.py --trade --news ＋ X headlines（`-p grok`・**3週連続成功**）＋ trade_results.md（**Boss/Rex が 8/22 に週足確定後の全面改訂版を作成**）＋ FRED実測CSV2件
> ⚠️ **wk02（2026-8-14）はスキップ。前週比はすべて wk01（2026-8-7）比＝2週間ぶん。**

### Macro / Regime
- 機械regime **`Gold Bid` を維持したが中身が入れ替わった**（equities **flat→up** / crypto **range→strong**）。**VIX 15.130** で **Add risk gate 開放継続**。
- ★**骨格は「ベセントの長期金利抑制策が1日で剥落した」こと**。8/20「**長期国債の買い入れを倍のペースに**」→ 木曜午前は長期金利低下→ドル安・円高・株高 → **1日で剥落**。「低金利→借入増→インフレ再燃→FRB利上げ圧力→長期金利が戻る」という**連立方程式の破綻**が、★**ドル円・US10Y・ゴールドの矛盾したシグナルの震源**。X側は**調達側**を足す（「**財源は短期債＝疑似ツイスト**」@vkrollup／「**結局は短期債の増発**」@steve_hanke）。
- ★**AI半導体が「成長→還元」フェーズへ**。ウォルマート決算ショックでダウ **-1.32%** の木曜に **SOX -0.53%** で踏みとどまったのは、**サムスンが SKハイニクスに続き FCF の50%（100兆ウォン）を株主還元へ**回すと発表したため。
- ★**8/21 米PMI 非製造業 56.8（予想54.0・+2.8上振れ）**。**8月のディスインフレ材料と正面から食い違う**が、⚠️**ソフトデータ同士でも割れており 1本で機構は閉じない**。
- ★★**FRED実測により年輪 8-2・8-3 がともに機構として棄却**（恒等式 全34営業日で誤差ゼロ）。

### Position / Orders
- CFDゴールド **残 1.0 Lot**（加重平均 **4,404.50**）。当週確定 **+113.50 pt·Lot（2勝0敗）**／含み **+200.30**／**レグ合計 +313.80**。★**全決済条件を 8/22 に改訂**（4,300 安値割れ → **4,400 日足実体下抜け ＋ 4H TL転換の AND**）で最悪ケースが **+9.0 → +109.0** に切り上がった。
- ★**JH を 1.0 Lot で跨ぐ構え**は年輪「イベント前に軽くする」と**一致していない**（要Boss判断）。
- Core: ★**リバランスで買付余力を引き上げ**（預り金＋スィープ **265,596円**）。総資産 **5,020,238円 / +9.05%**。★**米国株が -3.95% → +3.22% へ黒字転換**（**GDX +276.15 USD**）。国内は **GX半導体(2243) +311,460円**が最大の牽引。
- ⚠️★**金が CFD・GDX・GXゴールドの3層で重複**。**JH で叩かれれば同時に逆風＝分散されていない。**

### Key Levels (close-based)
- XAU 機械 **4,624.100**（GC=F）／ Boss現物週足終値 **4,604.80**・日中高値 **4,632.13** ／ ★**4,651.26 まで 19.13pt** ／ 下 **4,452 →4,400** ／ 上抜けなら **4,850圏**
- US100 29,308.859（Boss日足引け **29,293**）／ 上 **29,691→29,958→30,922** ／ 下 **29,130〜28,869**・**28,869割れで損切り**
- JP225 66,016.359（Boss「**66,779付近でレンジ**」）／ 押し目 **63,640〜64,768** ／ **65,963 上抜き定着で 66,800**
- USDJPY 158.940（Boss **158.972**）／ 買い **158.00〜158.70** ／ 損切り **157.55 / 157.15** ／ ★**159.18-159.20 超えは騙し警戒**
- EURUSD **1.1676** ／ 1.1600-1.1646 押し目 ／ **1.1575 割れでニュートラル** ／ DXY **98.799**・★**98.6（日足Fibo50）が支持**
- WTI 87.060（Boss **87.528**・高値88.377）／ ロード **84.90-85.70** ／ **88.40 超えで順張り** ／ ★**82.75 割れで撤退**
- 金利 **US10Y 4.738**（★**4.745% が今週最大の単一ライン**）／ **US30Y 5.276** ／ US5Y 4.424 ／ US3M 3.710 ／ ★**US2Y 4.215（Boss実測のみ）**・チャネル上限 4.240-4.275
- カーブ 5s10s **+31.4bp（bull_steepening）** ／ 3m10s **+102.8bp（positive）** ／ **belly_premium +21.3bp（瘤が再膨張）** ／ 10s30s **+53.8bp（Δ1w -3.1 / Δ30d +5.5 ＝符号が逆）**
- インフレ補償（FRED・as_of 2026-08-21）5Y BE **2.34%（Δ1w +10.0bp）** ／ 5y5y BE **2.34%（Δ1w +4.0bp）**
- VIX 15.130 ／ BTC 78,335.188（⚠️週末値）

### Gates（最重要：終値で判定）
- **Add risk: 開放**（VIX 15.13<18）。ただし**無理に順張りしない**。**9月上旬〜9/18 日銀利上げにかけて調整リスク＝来週中に利確意識**
- **Reduce / caution if**: **US10Y 4.745 上抜け** OR **US2Y 4.24-4.27 ブレイク** OR **DXY 98.6 割れ** OR **Gold 4,452→4,400** OR **US100 28,869 割れ** OR **WTI 82.75 割れ** OR **USDJPY 157.55/157.15 割れ**

### This Week Focus & Catalysts（行動: 8/24-）
- ★★**8/26(水) 米PCE / 米GDP** — **JH開幕の前日**。**指標を見てから講演を聞く順序**なので **JHのタカ/ハトは PCE に条件づけられる**。★**上振れなら PMI 56.8 と方向が揃い、タカ派側の織り込みが薄いまま材料だけ2本乗る＝最も重い配置**
- ★★**8/27-29 ジャクソンホール（ウォーシュ議長 初基調講演）** — **来週最大**。**ハト派＝織り込み済み／タカ派維持＝薄い**。★**確率は前者が高いが損失の非対称が大きいので構えは後者に合わせる**
- **9月上旬 円高転換の想定時期** ／ **9/18(想定) 日銀利上げ**（★日本株の急落は「**買い場として温存**」）／ **11月 米中間選挙**
- ⚠️**8/24週のカレンダーは PCE/GDP の2件しか取得できていない**／**GDP改定回次・PCE予想値も未取得**

### Signals (weekly, fixed keys)
- us10y_accel: bessent_buyback_decayed_4745_is_the_line（US10Y 4.738 が**レンジ上限4.745に接近**＝**矛盾の震源**。★**US2Y 4.215 は 8/14 の 4.104 から +11.1bp 戻し、「ピークアウト確定」の閾値4.154 の 6.1bp 上**＝**無効化条件がない**点が露出。belly_premium +18.9→**+21.3bp**）
- hy_oas_widening: walmart_shock_vs_samsung_return（ダウ-1.32%の中 **SOX -0.53%**。**サムスンが FCF 50%（100兆ウォン）を株主還元**＝**成長→還元フェーズ**。口座も **GX半導体 +311,460円**が最大の牽引）
- vix_spike: add_risk_gate_open_15_13（18割れ継続。ただし「**無理に順張りしない**」「**来週中に利確意識**」）
- wti_shock: iran_sanctions_real_ammunition（Boss日足 **87.528**・高値88.377。**下降ウェッジ上抜け**。UAEが対イラン取引を断つなど**実弾を伴う**。**82.75 割れでプレミアム剥落**）
- eps_revision_chain: real_yield_channel_rejected_8_2_and_8_3（★★**8/04 実質-3.0bpで金は動かず／8/05 実質+1.0bpの日に金が週最大の上げ**。**8-2・8-3 ともに機構として棄却**。⚠️ただし**|ΔDFII5|は最大5bp**で「実質金利は金を動かさない」には**まだ届かない**）

---

## Weekly Brief | 2026-8-28_wk04（2026-08-24 → 2026-08-28）
created: 2026-08-30 JST（snapshot end=2026-08-30）
market_theme: Warsh's hawkish Jackson Hole flips the rate regime back to bear flattening — gold -3.21%, DXY reclaims 99.430, USDJPY 160
> ★★ **【本週の特例・Boss指示 2026-08-30】米金利は、添付の終値チャートとレポート記載内容を1次情報として判断する。**
> Yahoo 側で **8/28 の金利4本が行ごと欠測**し、機械の金利値は **8/27（ウォーシュ講演の前）**だったため。

### Macro / Regime
- ★★**8/28(金)23:00 JST、ウォーシュ議長のジャクソンホール講演がタカ派で週のすべてを決めた。**「基調的なインフレが目標に向かって明確かつ十分な速さで進んでいると確信できなければ、**まだやるべき仕事がある**」「**65ヶ月続く高インフレの責任は中銀自身にある**」。★**PCE構成199品目のうち54%が前年比3%超**（コロナ前平均32%程度）という内訳も提示。→ **9月利上げ確率が CME FedWatch で約35% → 57〜60% へ急上昇**。市場は典型的な「**ベアフラットニング＋ドル高・逆金融相場**」で反応。
- ★★**金利レジームが完全に反転した**（Rex追記§A）。**US2Y 4.215→4.360%（+14.5bp）／US10Y 4.736→4.730%（-0.6bp）／US30Y 5.256→5.213%（-4.3bp）** ＝ **短期だけが上がり、長期はむしろ下がった**。**2s10s 52.1→37.0bp（-15.1bp）／10s30s 52.0→48.3bp／2s30s 104.1→85.3bp（-18.8bp）**。★**`2026-08-20 handoff §2-1` の「ベアフラット→ブルスティープ・転換点 8/7 21:30（NFP）」が3週間で無効化された**。⚠️**ただし「ブルスティープは誤りだった」と遡って書き換えない**——8/7〜8/21 は実際にその形だった。★**US30Y がほぼ横ばいだったことが「タカ派だが将来のインフレ抑制期待も同時に織り込まれた」という市場の解釈を示す**（Boss）。
- ★**効き方に時間差があった**: 速報段階では金 -1.7%・4,526程度と報じられたが、**NY引けにかけてさらに売りが加速し 4,454.26 まで沈んだ（表示されている支持線ちょうど）**。
- ★★**本アーカイブ初の日本国債実測**（**JP2Y 1.700%（+0.77%）／ JP10Y 2.919%（+0.93%）**）。8/27 の日銀氷見野副総裁発言（9月利上げに含みを持たせつつ明言回避）を受けた動き。★**日米とも金利上昇だが、前線（短期）の上昇幅は米国の方が大きく、金利差拡大観測が勝ってドル円が上放れた**。
- ★**週間で見ると3指数ともプラス**（S&P・ダウ +0.5%、ナスダック +0.9%）＝**NVIDIA 決算効果**。金曜だけ見ると下落だが、**週としては上げている**。

### Position / Orders
- CFDゴールド **残 1.0 Lot**（加重平均 **4,404.50**）。★**当週の確定トレードはゼロ**。週中高値 **4,673.78**（レグ +382.78）→ 週末 **4,454.26**（**+163.26**）＝ ★**-219.52 pt·Lot を返した**。含み **+49.76**（E1残 +53.13 ／ ★**E2残 -3.37 で含み損に転落**）。
- ★★**残玉は 1.0 Lot 継続で確定**（Boss確認 2026-08-29）。「4,500水準の4H実体下抜け確定 → 半値撤退」の条件は**金曜に成立していたが執行していない**。週明けの発動条件は trade_results §5 に更新済み。
- ★**週明けの発動条件は 4,500水準（上回れば継続／上回らなければ半値決済）と 4,400（全決済）**（trade_results §5。4,454.26 から **+45.7pt / -54.3pt**）。⚠️★**4,452 は「4Hダウ崩れ」＝可動の線で 4,605.16 → 4,519.97圏 へラチェット済み。固定の参照として残さない**（Boss 2026-08-29）。⚠️**ラダーが機能するのは寄りが 4,400〜4,520 に収まった場合のみ（幅120pt）で、8/28 の日足レンジは 186.63pt**。
- Core: 総資産 **5,053,619円 / +450,101円 / +9.77%**（前週比 **+33,381円**）。買付余力 **265,596円**（★預り金がスィープ専用口座に一本化）。**2243 +305,196 が牽引役を維持**（NVDA決算効果・⚠️wk03 の +311,460 からは -6,264）。★**GDX 102.83→99.65 USD で金の急落を直撃**したが**円安で円換算は小幅減に留まる**／★★**SPCX が +58.89 USD 改善**（**マスク氏の「2033年までに売上高3.5兆ドル」報道**でロックアップ不安が後退）。
- ⚠️★**wk03 で書いた「JH で金が叩かれれば CFD と現物の両方に同時に逆風＝リスクは分散されていない」がそのまま実現**。ただし **425A 特定 +20,925 の維持と円安による緩和で総資産レベルでは吸収された**。

### Key Levels (close-based / ★米金利は Boss 実測 8/28)
- **US2Y 4.360%**（★**日足チャートの 4.373%＝8月の上昇チャネル上限の 1.3bp 下。4.373 を日足実体で上抜けるかが最初の分岐**・Boss 2026-08-29）／ **US10Y 4.730%**（★**4.745% 突破なら一段高、失敗なら 4.4〜4.75% のレンジ継続**）／ **US30Y 5.213%**
- **JP2Y 1.700% / JP10Y 2.919%**（★本アーカイブ初）
- **XAUUSD 4,454.26** ／ ★**4,454.26 の維持が第一関門** → 割れれば **4,410.15 → 4,330台の移動平均線密集ゾーン** ／ 戻りは **4,519.97 → 4,660.71**（★当週跳ね返された線・n=2）
- **US100 29,453.4** ／ **29,466 を終値で明確に割り込むかが分岐点**（→29,320）／ **29,644〜29,935 を回復できなければ上値は重いまま**
- **JP225 65,821** ／ ★**65,634〜65,684 が生命線**（終値で割ると **60,488** 方向）／ レンジ上限 67,385〜68,450
- **USDJPY 160.079**（高値 160.203）／ 上 **160.508** ／ ★**160.50〜160.55 が口先介入リスクゾーン** ／ 下 **159.620 / 159.0**
- **EURUSD 1.15781** ／ ★**1.15749（日足MA付近）を明確に割るかが焦点** ／ 戻りの目安 **1.16687〜1.16602**
- **DXY 99.677** ／ 上 **100.335** ／ 下 **99.430 → 98.687**（★**割った 99.430 を回復してその上で引けた**）
- **WTI 84.059** ／ 下限 **82.749〜82.895** ／ 上限 **86.167**
- **BTC 78,100前後**（報道ベース）／ ★**75,200〜78,000 帯で下げ止まるかが分岐点**
- **VIX 14.510**（機械・18割れ継続）／ インフレ補償（FRED as_of 8/28）**5Y BE 2.30%（Δ1w -4.0bp）／ 5y5y BE 2.32%（Δ1w -2.0bp）＝両方 narrowing で wk03 から方向反転**

### Gates（最重要：終値で判定）
- **Add risk: 開放**（VIX 14.51<18）。ただし骨格は**ベアフラット＋ドル高の逆金融相場**。★**US2Y 4.373%（8月の上昇チャネル上限）を日足実体で上抜けるかを最初に見る**
- **Reduce / caution if**: **US10Y 4.745% 突破** OR **Gold 4,454.26 割れ** OR **US100 29,466 割れ** OR **JP225 65,634〜65,684 割れ** OR **USDJPY 160.50〜160.55** OR **EURUSD 1.15749 割れ** OR **WTI 82.749 割れ**
- ⚠️★**機械の watch_zone（161.0）は Boss の口先介入ゾーン（160.50〜160.55）より高い**。機械が calm を出していても**Boss 基準では 0.42〜0.47 円しかない**

### This Week Focus（行動: 8/31-）
- ★**US2Y 4.373%（8月の上昇チャネル上限）を日足実体で上抜けるか**＝「利上げ確率 57〜60% がさらに織り込まれるか」の最初の分岐（8/28終値 4.360% は 1.3bp 下）／**US10Y 4.745% 突破 vs 4.4〜4.75% レンジ**
- ★**Gold 4,454.26 の維持**（第一関門）。割れれば 4,410.15 → 4,330台
- ★**9/18（想定）日銀会合** — **JP2Y 1.700%・JP10Y 2.919% で高値圏**。⚠️**9月利上げの織り込みが Boss（明言回避＝ハト派寄り）と X（約80〜90%・未検証）で割れている**
- ★**9月の米雇用統計・PCE** — 利上げ確率 57〜60% を裏付けるか。**金の戻り余地を決める**
- **9月のAIデータセンター計画の遅延・中止懸念**（動画側が「下振れの方が勝率高い」とした根拠）／ **DXY 100.335 を試すか**
- ⚠️**イラン制裁の拡大（--news ③）vs ホルムズ通航量の半分回復（本体）＝両方向の材料が同時進行**

- ★**§D（DFII5）は【判定保留】**——生CSVで **DGS5/DFII5 の 8/28 行の不在**を確認（窓の問題ではなく H.15 と breakeven の公表タイミング差）。**ΔT5YIE = -1.0bp → ΔDFII5 = ΔDGS5 + 1.0bp**。★**【Boss 2026-08-29】8/28 の日次Δ US2Y +12.6bp / US10Y +5.4bp で挟むと ΔDGS5 ≈ +5〜+13bp → ΔDFII5 ≈ +6〜+14bp。符号は正でほぼ確定し、分岐は「+5bp以上」の公算**。★**代理指標ではない**（恒等式と他年限による範囲の制約）ので **8-2 の失敗とは違う**が、**判定は DGS5 の実測が出るまで動かさない**。★★**8/3-8/7 は入力が無くて検定できなかったが、今回は入力がある——|ΔDFII5| が 5bp を超える公算が高い時点で、この検定は初めて有効になる**。
- ★★**3M フロントの是正は A＋B の併用で決定**（Boss 2026-08-29）: **A=FRED `DGS2`/`DGS10` を追加**（`FRED_SERIES` に1行・軽い。★**副次効果として単一ベンダー・NY引け基準の 2s10s が手に入り、年輪§8(e) の混在から構造的に自由なカーブが1本持てる**。⚠️**H.15 は1営業日遅れるので速報性は解決しない**）／ **B=3M系ラベルに「政策期待の判断には使えない」と用途制限を明記**。→ ★**速い系列（Boss実測）と揃った系列（FRED）は別レイヤーで持ち、統合しない**。**残り4件（NaNテスト・per-pair as_of・watch_zone・登録テンプレート）も承認**。

### Signals (weekly, fixed keys)
- us10y_accel: rate_regime_reversed_to_bear_flattening（★★**US2Y 4.360%（週間+14.5bp）／US10Y 4.730%（-0.6bp）／US30Y 5.213%（-4.3bp）＝短期だけが上がり長期は下がった**。**2s10s 52.1→37.0bp（-15.1bp）／2s30s 104.1→85.3bp（-18.8bp）**。★**8/7 の「ブルスティープ転換点」は3週間で無効化**（⚠️遡って書き換えない）。★**US2Y ピークアウト宣言を本週次で撤回**——閾値4.154%に対し **8/28終値 4.360%＝+20.6bp** で、**無効化条件（日足4.230圏を実体で回復）は 2026-08-22 提案（wr-2026-8-21.md §E）→ 2026-08-23 登録で、当週に完全に達成された**。★**置いていたからこそきれいに撤回できた**）
- hy_oas_widening: warsh_hawkish_jh_flipped_everything（★★**ウォーシュのJH講演がタカ派で9月利上げ確率が約35%→57〜60%へ**。「65ヶ月続く高インフレの責任は中銀自身にある」「**PCE構成199品目のうち54%が前年比3%超**」。★**US100 29,453.4 は事前の分岐点 29,466 のすぐ下で着地**したが、★**週間では3指数ともNVIDIA決算効果でプラス**——**金曜だけ見ると下落、週としては上昇**）
- vix_spike: add_risk_gate_open_14_51（18割れ継続。⚠️ただし**骨格はベアフラット＋ドル高の逆金融相場**で、**無理に順張りしない**）
- wti_shock: sanctions_expand_while_hormuz_normalizes（**84.059（-0.18%／週間 -3.61%）**でレンジ中心に着地。★**ウォーシュ発言の直接的なインパクトは限定的**。⚠️★**--news ③がイラン制裁の第三国銀行への拡大（エジプトのバンク・ミスル）を報じる一方、本体は「ホルムズのタンカー通航量が半分まで回復＝供給正常化」を紹介——両方向の材料が同時進行**。下限 82.749〜82.895／上限 86.167）
- eps_revision_chain: gold_rejected_at_4660_n2_and_data_integrity_failure（★**金は 4,454.26（-3.21%／-147.69）**、高値4,631.87からの急落で**事前の強気シナリオは完全否定**。★★**8/25-26 に高値 4,673.78 を付け週足Fibo23.6（4,660.71）を上抜けて跳ね返された＝8/6 と同型で n=2**。★**事前登録した非対称が低確率側で的中したが、「行動」が登録されていなかったため発火しても何も起きなかった**→ `trigger`/`action`/`invalidation` の3欄必須化を提案。★★**技術面では本週の snapshot の日付がペアごとに割れた**——Yahoo の 8/28 欠測で**金利4本は 8/27（ウォーシュ講演の前）**、**US100 は NaN**。さらに★**NaN が「欠損」ではなく誤ったラベルに化けた**（`equities=flat` / `verdict=mixed`）＝**「欠損は気づかれるが間違った値は気づかれない」の実例**。★★**機械 `bull_flattening` vs Boss「ベアフラット」の逆ラベルは、front の選び方の差ではなく指標設計の系統的バイアス**（Boss訂正 2026-08-29）——**3M は政策金利そのものに貼り付いており利上げ確率の織り込みを構造的に持たないため、利上げ観測でフロントが売られる局面では機械は必ず `bull_flattening` を出し続ける**。**A: front を 2Y（FRED `DGS2`）に替える／B: 3M系ラベルに用途制限を明記する** の二択を関所に上げた。**2026-06-27 の年輪の同型の再発だが一段深い**——当時は『代理が届かない』、今回は『**代理が特定の局面で必ず一方向に誤る**』。★あわせて **NaN 監査の範囲は上記2関数ではなく『終端フォールバックを持つ判定関数の悉皆』**、**是正は『各判定関数に NaN を食わせて `unknown` を返すテストを1本』**（Boss訂正）。★**§D の DFII5 は生CSVで 8/28 行の不在を確認済み**（窓の問題ではない）で、**ΔT5YIE = -1.0bp から ΔDFII5 = ΔDGS5 + 1.0bp まで確定・未知数は ΔDGS5 だけ**）

---

## Weekly Brief | 2026-9-4_wk01（2026-08-31 → 2026-09-04）
created: 2026-09-06 JST（snapshot end=2026-09-06）
market_theme: NFP +162k with double upward revisions flips the yen thesis - US steepens while Japan flattens, gold -0.52% but P/L +173.27 pt-Lot on execution

> ★ **本週は snapshot の日付が揃っている**（全ペア 2026-09-04・BTCのみ週末値9/6）。**wk04 の「金利4本が8/27・US100がNaN」という特例は当週には適用しない。**
> ★**機械 US10Y 4.784 = Boss TVC 週足終値 4.784（完全一致）。** ⚠️ただし **wk04→wk01 の機械の金利差は 8/27→9/4（6営業日）**で週次ではない——**週間騰落は Boss 実測が正本**。

### Macro / Regime
- ★★**9/4(金)21:30 の NFP が +16.2万人（予想5.5万人の3倍近く）、しかも 7月 -2.3万人→+2.1万人・6月→+3.1万人の二重の上方修正。** 失業率 4.1% 据え置き、平均時給 前年比 **+3.1%**（前月3.2%から鈍化＝**インフレ再燃の決定打にはならない**）。→ **「雇用は冷えているが崩壊していない」から「雇用は底堅い」への解釈転換**。教科書通りの**グッドニュース・イズ・バッドニュース**で、**9月FOMC利上げ織り込みが 52-54% → 59-61%**、米金利は全年限で上昇、ドル指数も上昇、**株は逆に売られた**（ダウ -0.51% / S&P -0.38% / NASDAQ -0.29%。★**小型株ラッセル2000のみ +0.25%**）。
- ★★**Boss の短期予想（NFPが5.5万人を超えたら円安に巻き戻る）は的中したが、中期予想（水曜まで円高）の前提だった「弱い雇用統計→FRBは動けない」が崩れた。** → **来週前半は円高シナリオの再検証が必要**。
- ★★**米はスティープ化、日はフラット化。逆方向**（Rex§A・本体に項目なし）。**米 2s10s 37.0→41.0bp（+4.0bp）** は US10Y +5.4bp の**長期主導**、**日 2s10s 121.9→108.5bp（-13.4bp）** は **JP2Y +12.7bp（当週で最も動いた金利）** の**短期主導**。日銀9/17-18 の織り込みが2年に集中し、10年は **GPIF の国内債回帰**で頭打ち。
- ★★**円高を駆動しているのは「短期の金利差」**（Rex§B）。**2年 日米差 266.0→254.7bp（-11.3bp 縮小）／10年 日米差 181.1→187.2bp（+6.1bp 拡大）／USDJPY -2.43%**。→ **円高は短期の金利差縮小と同方向、長期の拡大とは逆方向＝当週の円高は2年ゾーンが駆動**。⚠️**サンプルは当週1件のみ。機構は閉じない**（→ 事前登録 P11）。
- ★★**JH のタカ派効果は1週間で一部剥落していた**（Rex§C）。**35%（JH直前）→ 57-60%（JH直後）→ 52-54%（NFP直前）→ 59-61%（NFP直後）**。**NFPはそれを元の水準に戻しただけで、JH直後を大きく超えてはいない。** → **イベント由来の織り込みは減衰する**という観測。⚠️**P9 と同型だが主体も対象も違うので同じ機構とは扱わない**。
- ★**日経の +1.77% は円安の追い風ではなく別材料**（Boss）——**GPIF の国内回帰方針**と**キオクシア新型BiCSフラッシュ材料**（★**200A・2243 保有と整合的**）。
- ★**8/21 にタカ派材料として記録した「サービスPMI 56.8」は 9/3 の確報で 56.5、コンポジットは -1.0 の大幅下方修正。** 当時「**ソフトデータ1本で機構は閉じない**」と記録した判断が**確報で裏づけられた**。⚠️同日 ISM非製造業は +1.2 上振れで方向が逆＝**割れは続いている**。

### Position / Orders
- CFDゴールド **残 0.5 Lot @4,311**（新キャンペーン）。**ゼロ点 4,015.00**。★**確定5件・4勝1敗（勝率80.0%）／実現 +163.00 pt·Lot**。旧キャンペーン（8/19-9/1）は **+129.00 で完結**、新キャンペーン（9/2-）は確定 +147.50 ＋ 含み +60.03 ＝ **+207.53**、**通算 +336.53**。
- ★★**金が週間 -0.52% 下げた週に通算は +163.26 → +336.53（+173.27）＝価格ではなく執行が作った週。** 効いた3操作は ①**旧キャンペーンのラダー**（4,380一括の +89.00 に対し **+129.00**・差 +40.00）②**9/2 の再エントリー**（再参入しなければ +129.00 止まり・差 +207.53）③**NFPの往復**（+10.00、**ゼロ点は 4,232→4,222 に低下**）。
- ★★**wk04 で「事前登録に行動が書かれていなかったため、発火しても何も起きなかった」と記録した設計の欠落が閉じた。** 2026-08-29 に `trigger`/`action` を対で登録した2件（**寄りが4,500水準を上回らなければ半値決済 → 8/31 09:30 @4,460 執行**／**4,400を割れば全決済 → 9/1 20:00 @4,380 執行**）が**登録どおりに2件とも執行**された。→ **3欄必須化の提案は実効性が確認された**。
- ★**撤退設計（Boss確定 2026-09-05）**: **週足最終防衛 4,280水準の4H実体下抜け確定 → 撤退**。4,280 は **9/2 の安値＝このキャンペーンの起点**で、**起点を割れば上昇の前提そのものが消える**。★**撤退しても +132.00 が残る**（旧キャンペーンは撤退水準でほぼゼロだった）。**週足終値から 151.07pt（-3.41%）** で、**3連休の窓が一段でこれを飛び越えるには 8/28（-3.21%）に匹敵する規模が要る**。
- Core: 総資産 **4,906,965円 / +321,241円 / +7.00%**（前週比 ★**-146,654円**）。スィープ **251,782円**。★★**当週の主役は為替の素通し**——**米国株は外貨建てで +155.26→+233.26 USD（+78.00 USD / +2.46pt）改善したのに、円換算では +20,021→+21,411円（+1,390円）しか増えていない**。★**最も明快なのは SPCX**: 外貨建 **-73.19→+10.66 USD でプラス転換**したのに**円換算は -9,418円**（取得時 USDJPY ≈162.1 vs 現在 ≈156.3）。→ **trade_results §17「2243・1655 はほぼ確実にヘッジ無し」で予告された素通しが口座の数字に出始めた**（⚠️目論見書での確定は未実施）。
- 銘柄別: **2243 +272,136**（-33,060・単独最大の牽引役は維持）／2638 +44,969／2847 +28,240／1655 +26,622／**425A特定 +7,800**（-13,125）／586A +1,900／200A -637／**7011 -12,600**（★+14,500 から符号反転・-27,100 で個別最大の悪化）／**6954 -27,400**／**425A NISA -41,200**（★-35,000）。
- ★★**513A は 9/1 のリバランスで売却済み**（Boss報告 2026-09-06 / `trade_results.md` §10 訂正版）。関所で上げた3つの疑問（保有一覧から消滅／§10『当週の売買なし』と矛盾／スィープが売却の向きと逆）は**1件のリバランスで全部説明がついた**: **513A 売100口@847.2 = 84,720 ／ 200A 売1口@4,282 ／ 200A 買24口@4,284 = 102,816 ＝ 差引 ★-13,814**。★★**スィープの減少額と完全一致**——**売却代金を上回る額を 200A に投じたから現金が減った。矛盾ではなく整合だった**。★**513A 実現損 -17,780円**（100口 @1,025 → @847.2）＝**損出しは執行済み**（**6954 は未執行のまま**）。**200A は 68口@4,327 → 91口@4,316**（買24 − 売1 の純増・画面表示と一致）。★**8/23以降『自律反発を待つ』として保留していた判断が 9/1 に決着**（839 → 847.2 で **+820円**、税効果込み約+650円）→ ★**『税は急ぐ理由にならない』は結果としても正しかった**。⚠️**§10 初版の『当週の売買なし』は Rex側が執行報告を受けていなかったための欠落で、訂正版に差し替え済み。当週は証券口座の売買が「あった」週である**。
- ★**評価損益の比較は構成が変わっている**。wk04 の +450,101 には **513A の含み損 -16,500** が含まれていた。513A を除いた比較可能ベース **+466,601** に対し当週は **+321,241** で、差は ★**-145,360**——**ヘッドラインの -128,860 より約16,500 大きい**（⚠️200A 買い増し分があるため厳密な同一構成比較ではない・概算）。
- ★★**425A の騰落を「金の週足」と比べてはいけない — 窓の不一致**（trade_results §10-5）。**425A 週間 -4.48%**（390.9 → 373.4）に対し、金の週足 -0.52% ＋ 円 -2.43% の合成は **-2.93%** で ★**1.54pt 合わない**。**原因は東証ETFが「東証引け 15:00 JST」時点の原資産を反映すること**で、★**8/28 15:00 はウォーシュ講演（23:00）の前**——その時点の金は約4,600圏。**15:00 基準で再計算すると -4.90% となり実測 -4.48% とほぼ一致する**。→ ★★**東証上場の外貨建てETF（425A・2243・1655）を CFD/FX の週足終値（土06:00 JST）と突き合わせるのは窓の不一致。年輪§8(e) の同型。東証銘柄の週次比較には「東証引けの原資産」を使う**。⚠️**§17 の為替ヘッジ検証もこの窓ずれを含んだ概算**（★**ただし 1655 と US100 の乖離 2.0% は窓ずれで説明できる幅を超えるので結論は変わらない**）。

### Key Levels (close-based / ★米金利・日本金利は Boss 実測 9/4 週足終値)
- **US2Y 4.374%**（+1.4bp。O4.339 H4.423 L4.331）／ ★**上昇チャネル上限 4.416% はその 4.2bp 上。上抜けで 4.42-4.43%台へ追随、鈍化なら 3.672%（チャネル下限）方向**
- **US10Y 4.784%**（+5.4bp。O4.762 H4.810 L4.748）／ **サポート 4.745%（割れは金利低下トレード）／ 4.810 超えは上昇継続のブレイク → 次の節目 4.85%**
- **JP2Y 1.827%**（★**+12.7bp・当週で最も動いた金利**）／ **1.848%（直近高値）超えは加速のサイン** ／ **JP10Y 2.912%**（-0.7bp）／ **2.90-2.92% が当面のレジスタンス帯**
- **XAUUSD 4,431.07**（週足 **-0.52%** / 日足 **-0.94%**。O4,436.90 H4,510.90 **L4,282.45**）／ ★**まず 4,400 ラインを守れるか** → 割れれば **4,367.10 → 4,337.74（200日線近辺）→ 4,282** ／ ★**4,280 の4H実体下抜け確定で撤退** ／ 戻りは **4,490.32 → 4,519.97 → 4,573.95**
- ⚠️**4,400 圏は3本が10pt以内**（短期波Fibo50 **4,397.93** / 日足波Fibo38.2 **4,409.24** / キリ番 **4,400**）。**現時点では区別する実益がないが、上昇が続くと分かれる。★可動の線は再計算してから使う**（trade_results §15）
- **US100 CFD 29,493.3** ／ **29,157-29,271 が直近サポート**（★**割れは押し目待ちより下値警戒優先**）／ **29,541-29,754 は利食い目線**
- **JP225 CFD 65,813** ／ 次のターゲット **65,400-65,800** ／ 直近抵抗 **67,385** ／ 短期スイングは下値 64,853-65,200・上値 65,800-67,385 ／ ★★**9/18 接近での新規ロング積み増しは避ける**
- **USDJPY 156.195**（H156.750 L155.289）／ 戻り売り一次 **156.50-157.20**・二次 **158.10-158.60** ／ 下値サポート **155.30-155.70** → 割れれば **154.40-154.90**
- **EURUSD 1.16130** ／ 下値 **1.15759-1.15599** ／ 上値 **1.16494-1.16603** ／ **1.1660 上抜けか 1.1580 割れのブレイク待ち**
- **WTI 91.784**（+9.19%。H92.685 L89.237）／ サポート **89.599-88.320** ／ 中期 **86.167**（割れは中期トレンド転換のシグナル）／ 抵抗 **92.404-92.685**
- ⚠️**BTC 未確定**（Rex§F）: 本体本文 **79,540.37** ／ 出典タイトル **$81,000超**で約1,500ドルの差。**片方を採用して確定値にしない**。テクニカルは 77,588 サポート／80,415-81,375 戻り高値／83,795 上値大台

### Gates（最重要：終値で判定）
- **Add risk: 開放**（VIX 14.53<18）。⚠️ただし骨格は**「FRBのタカ派再評価（9/16 FOMC）」と「日銀・GPIF由来の構造的円高圧力（9/17-18 会合）」の綱引き**で、★★**9/10 PPI・9/11 CPI が決着点**。★**9/7(月) は米国休場（レイバーデー・株式のみ）＝3連休で窓が通常より1日長い**
- **Reduce / caution if**: ★**US2Y 4.416% 上抜け** OR **US10Y 4.810 超え** OR **Gold 4,400 割れ**（→4,367.10→4,337.74→4,282。★**4,280 の4H実体下抜けで撤退**）OR **US100 29,157 割れ** OR **JP225 ★9/18 の日銀会合そのもの**（2024年8月型の急落リスク）OR **USDJPY 155.30-155.70 割れ** OR **WTI 89.599 割れ**（86.167 割れで中期転換）OR **BTC 77,588 割れ**

### This Week Focus
- ★★**9/11(金) 米CPI が最重要**。**当週の原油 +9.19% が数字に出るかの最初の確認**で、ウォーシュが「PCE構成199品目の54%が前年比3%超」と述べた直後の回。**タカ派材料が積み上がるかが決まる**
- ★**9/10(木) 米PPI ＋ ECB理事会**（ECBが先・米CPIが後という時間差がユーロドルのトリガーになりやすい）／ **9/9(火) EIA月報**（★**P12 の判定日でもある**）
- ★**9/15-16 FOMC**（誘導目標 3.50-3.75%、利上げ確率 59-61%）／ ★★**9/17-18 日銀会合**（利上げ確率約8割、0.25%が基本線・**0.5%の可能性も**）
- ★**Boss が「来週最も規律を要する」とした2点**: ①**ゴールドの既存ロングは 4,400ドルラインまで距離が縮まっている** ②**日本株は 9/18 接近に伴うヘッドラインリスク**
- ⚠️★★**新しい故障モード — GC=F（機械の XAU/USD）が同じ 2026-09-04 の終値として1時間以内に2つの値を返した**。**12:32 実行 4,429.800（Boss現物との差 -1.27）→ 約1時間後 4,476.600（差 +45.53）＝ +46.80（+1.06%）**。★**`fast_info.lastPrice` が 4,476.60 で「9/4 の終値」と一致**していたため、**最終バーのライブ気配上書きか継続限月のロール（GCU26→GCZ26）の可能性**（⚠️**未確定**）。→ ★★**機械の XAU/USD は「日付は正しいのに値が安定しない」。本週の判断には使わない**（★**Boss 現物 4,431.07 が正本なので結論は変わらない**）→ ★**要Boss判断**。⚠️★**wk04 の「日付が割れる」とは別の故障モードで、H-4 では捕まえられない**。⚠️**wk04 の 4,478.100 が同じ現象の影響を受けていたかは未確認。遡及編集の禁止により wk04 は書き換えない**。
- ★**H-4（per-pair の as_of）と『窓の定義フィールド』を実装**（Boss 2026-09-06「実装推奨」「次の一手」）。snapshot 冒頭に ★**`snapshot_date_integrity`（aligned / SPLIT / missing）**を出し、各ペアに `as_of` / `prev_1w_as_of` を持たせた。★**24/7 銘柄（BTC/USD）は `off_calendar_*` の別枠**——**常に日付が違うので SPLIT に数えると毎週点灯し、常時点灯する警告は読まれなくなる**。あわせて **`change_*_bp_1w_window`** を追加し**実際に引き算した2日を値の隣に出す**（当週の curve_fred は `2026-08-27 -> 2026-09-03` で **8/28 を跨がない**ことが一目で分かる）。
- ✅★★**2243・1655 の為替ヘッジが一次資料で確定**（Boss 2026-09-06 / `trade_results.md` §18）——**両方とも原則ヘッジなし**。あわせて**連動指数も確定: 1655 = S&P 500（500社に分散）／2243 = フィラデルフィア半導体株指数 SOX（米国上場の半導体主要30社・テーマ型）**。★**3週以上持ち越していた項目が閉じた**。★**あわせて 2026-08-23 の記録を訂正**（`etf_lookthrough_2026-08-23.md` に 2026-09-06 付で追記・遡及編集はしない）——**2243 の「上位10で 69.21%」を集中として読んだのは誤りで、SOX は30銘柄の時価総額加重指数なので正常な分布**。★★**誤りの型は「事実が違った」ではなく「並べ方で誤った含意が乗った」**（200A の上位3で 54.79%＝本物の集中と同じ表に並べたため）。★**「実体は国内ではなく米国半導体だった」という指摘そのものは正しく、乗ったのは「しかも集中している」という余分な含意の方**。★★**§17 の検証手法（為替を引いて原資産を逆算）が独立した一次資料で裏づけを得た**が、⚠️**限界も同時に確定**——**代理指数のずれを含む／円の変動が小さい週には使えない（当週は -2.43% と大きかったので分離できた）／n=1で一般則にしない**。★**USD建て約30%は全部ヘッジ無しと確定したが、為替は共通でも原資産のリスクは揃っていない**（1655=S&P500 の分散 vs **2243=SOX 30社のテーマ型で値動きがかなり激しい**）——**当週は 2243 が円建て -4.29%、為替 -2.43% を引くと原資産 -1.86% で同方向に効いた**。
...
### Signals (weekly, fixed keys)
- us10y_accel: us_steepens_while_japan_flattens（★★**米 2s10s 37.0→41.0bp（+4.0bp・長期主導のスティープ化）／日 2s10s 121.9→108.5bp（-13.4bp・短期主導のフラット化）で逆方向**。**JP2Y +12.7bp が当週で最も動いた金利**で、日銀9/17-18 の織り込みが2年に集中し 10年は GPIF の国内債回帰で頭打ち。⚠️Boss は「**日銀が短期を利上げしても長期がブル・フラットニング的に頭打ちになるリスク**」を警戒し、**日本国債はスティープ化（2年上昇・10年頭打ち）のポジションが妥当**としている）
- hy_oas_widening: nfp_upside_surprise_flipped_the_yen_thesis（★★**NFP +16.2万人＋二重の上方修正で「雇用は底堅い」への解釈転換**。9月利上げ確率 52-54%→59-61%。★**X側は本体に無い論点を足している**——**NFPの内訳が狭い**（飲食・バー ~59k ＋ 地方政府の教育 ~42k、季節調整の影響で「広範な好況ではない」）。⚠️**未突合**。★★**JH のタカ派効果は1週間で 57-60%→52-54% へ一部剥落しており、NFPはそれを元の水準に戻しただけ**＝**イベント由来の織り込みは減衰する**）
- vix_spike: add_risk_gate_open_14_53（18割れ継続。⚠️骨格は**FRBのタカ派再評価と日銀/GPIF由来の円高圧力の綱引き**で、**9/10-11 の PPI・CPI が決着点**）
- wti_shock: oil_geopolitics_two_directional_again（★**WTI 週間 +9.19%（84.059→91.784）が当週最大の変化**。**92ドル手前でダブル/トリプルトップ**。★**--news 2件がともにイラン**で、**①米軍がイランのタンカー3隻を攻撃・破壊**と**②トランプ大統領が「取るに足らないことだ」と矮小化**——⚠️**方向が逆の材料が同時に出ている**。**wk04 の「制裁拡大 vs 通航量回復」と同じ構図。どちらも記録し、片方に寄せない**）
- eps_revision_chain: execution_not_price_and_three_machine_debts_closed（★★**金が週間 -0.52% 下げた週に通算は +163.26→+336.53 pt·Lot（+173.27）＝価格ではなく執行が作った週**。**確定5件・4勝1敗（勝率80.0%）** で、**wk04 で記録した「事前登録に行動が書かれていなかった」設計の欠落が、trigger/action を対にした登録により2件とも執行されて閉じた**。★★**機械側の宿題も3件まとめて閉じた**: ①**§D の事前登録が「+5bp以上」の行で決着**——**ΔDGS5 +10.0bp / ΔDFII5 +11.0bp / 恒等式 0.00** で、**wk04 で立てた範囲制約（ΔDGS5 +5〜+13 → ΔDFII5 +6〜+14、符号は正、分岐は「+5bp以上」）が実測で的中**し、**関係式 ΔDFII5 = ΔDGS5 + 1.0bp も厳密に成立**。⚠️**判定文は書かない**（handoff §5-5。新規候補の定式化は Boss/Rex 側）。★**公表タイミング差も再現（n=2）＝構造** ②**是正A/B を実装**——**FRED DGS2/DGS10 で `curve_fred` 新設**（curve_spreads とは統合しない）。★**初回で2つ分かった**: **別フィードでも週次Δが +4.0bp で完全一致し水準だけ 2.0bp ずれる**（n=1）／★★**機械の Δ1w が -4.0bp と符号ごと逆に出た**——**7暦日ルックバックが 8/28 を跨がず 8/27 に落ちた**ためで、**8/28 の1日で 2s10s は -8.0bp フラット化しており、この1日を窓に入れるか外すかだけで符号が反転する**＝**「必ず窓を明示して引用する」の実例がもう1件** ③**NaN→unknown の悉皆是正**——**`_num()` で値の入口を1箇所に絞り**、テスト `tests/test_regime_nan.py` 4本 **4/4 pass**。★**本丸は「NaN と None で regime ブロックが完全一致すること」** で、**新しい判定関数を足したときに穴が開いた瞬間に落ちる**）


## Weekly Brief | 2026-9-11_wk02（2026-09-07 → 2026-09-11）
created: 2026-09-12 (JST) / 関所7.5承認待ち / Astra統合

### Macro / Regime
**Equities Down / Oil Surge** ← Gold Bid。30日株安・原油高と、金曜株反発/VIX低下を別窓として読む。米2Y+25.6bp、10Y+18.5bpで2s10sは33.9bpへフラット化。日米2年差+24.1bpなのに円高-1.7459%となり、金利差単独説明は保留。CPI総合0.4/3.4、コア0.3/2.4。原本の日経現物値を公式64,011.34/-1.93%に訂正。

### Position / Orders
Gold残0.5Lot@4,330.23。今週確定3件+96.385 pt・Lot、全通算実現372.885+含み9.050=381.935。前週未丸め比+45.400。9/9キャンペーン計は62.935。銀行移動5万円を除く証券口座週変化-106,336円（国内-100,538/US-5,798）。総資産4,750,629円、評価損益+214,905円。新規注文・自動再エントリー未設定。

### Key Levels (close-based)
Gold4,348.33、出口4,319.13–4,306.50＋週足下降線の4H実体下抜け。最終判断4,280.10、逆指値置き4,260。US100 CFD29,371.2（28,869/29,935）、USDJPY153.468（下152.850/152.103、戻り154.120/154.747–155.692）、WTI cash100.374（98.143/104.825/107.577）。TVC US2Y4.630%、US10Y4.969%、JP2Y1.842%、JP10Y2.987%。

### Gates（最重要：終値で判定）
Add risk gate=open（VIX15.85<18という許可条件）。Reduce risk gate=caution（イベント前・金利上昇・既存出口監視）。VIX単独で追加せず、Gold通常4H条件と**9/14下窓4,280.10以下なら即時撤退**というBoss指定例外を分ける。CFD差674.66を日経月曜の確定ギャップ幅にしない。

### This Week Focus
FOMCは**日本9/17 03:00声明/03:30会見**、日銀9/17–18（結果9/18）。日米の決定と価格反応を別記録。FRED実質5Y+12bpは9/4→9/10でありCPI後ではない。9/11BEは前日比-6bp、同日実質は欠測。P12はYahoo9/9で参考達成だが同FXCM正式判定保留。BTCは機械9/10/画像9/12進行バー。Xの公式本文再確認未了。

### Signals (weekly, fixed keys)
- us10y_breakout: watch（米2Y/10Yとも上昇。ベアフラット化の窓はTVC9/4→9/11。機械3M系と政策期待を混ぜない）
- dxy_breakout: watch（DXY99.094、98.687支持/99.430抵抗。ドル円円高を金利差だけで説明しない）
- hy_oas_widening: unknown（当週の新しいHY OAS実測なし。CPIなど別指標をこの欄の実測として代入しない）
- vix_spike: off（TVC15.85、機械15.840、許可条件は開放）
- wti_shock: watch（WTI cash週+9.3589%・金曜-3.76%、30日機械+23.14%。供給経路報道と需要/利確仮説を分離）
- eps_revision_chain: unknown（当週の新しいEPS連鎖改訂データなし）

詳細: [review](../logs/weekly/2026/2026-9-11_wk02/review.md) / [note](../logs/weekly/2026/2026-9-11_wk02/note.md) / [meta](../logs/weekly/2026/2026-9-11_wk02/meta.yaml) / [当月distilled](../distilled/2026/distilled-gm-2026-9.md) / [人間用ハブ](../logs/weekly/2026/2026-9-11_wk02/CFD戦略-2026-9-14.md)
