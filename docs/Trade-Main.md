...
- **US2Y 4.360%**（★**維持・上抜けが「タカ派継続」のバロメーター**）／ **US10Y 4.730%**（★**4.745% 突破なら一段高、失敗なら 4.4〜4.75% のレンジ継続**）／ **US30Y 5.213%**
...
### Gates（最重要：終値で判定）
- **Add risk: 開放**（VIX 14.51<18）。ただし骨格は**ベアフラット＋ドル高の逆金融相場**。★**US2Y 4.360% の維持・上抜けを最初に見る**
...
- ★**US2Y 4.360% を維持・上抜けするか**＝「タカ派継続」の裏付け／**US10Y 4.745% 突破 vs 4.4〜4.75% レンジ**
