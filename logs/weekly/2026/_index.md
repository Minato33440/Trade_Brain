...
- Key gates:
  - Add risk: **開放**（VIX 14.51<18）。ただし骨格は**ベアフラット＋ドル高の逆金融相場**。★**US2Y が 4.360% を維持・上抜けするかが「タカ派継続」のバロメーター**。米国株は **29,466 を終値で明確に割り込むかが分岐点**（割れれば 29,320 方向）、**29,644〜29,935 を回復できなければ上値は重いまま**
  ...
  - ★**CFD一次シグナル 4,452 に対し週末終値 4,454.26 は 2.26pt 上——極めて近い**。★**残玉は 1.0 Lot 継続で確定**（Boss確認 2026-08-29。撤退条件は金曜に成立していたが**執行していない**）
- Links:
